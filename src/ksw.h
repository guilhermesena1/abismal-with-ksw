...
extern "C" {
	 ...
	 */
  kswr_t ksw_align(const int qlen, const int tlen,
                   const int8_t *mat,
                   uint8_t *query, uint8_t *target, kswq_t **qry);
  int ksw_global(const int qlen, const uint8_t *query, int tlen, const uint8_t *target,
                 const int m, const int8_t *mat, const int w,
